...
function project_pdf_create($db, $object, $extrafields, $modele, $outputlangs, $hidedetails=0, $hidedesc=0, $hideref=0)
{
	global $conf,$langs;
	$langs->load("projects");
	...
	if ($filefound)
	{
		...
		if ($obj->write_file($object, $extrafields, $outputlangs, $srctemplatepath, $hidedetails, $hidedesc, $hideref) > 0)
		{
